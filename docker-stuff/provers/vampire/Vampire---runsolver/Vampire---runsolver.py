...
if __name__ == "__main__":
    ...
    run_vampire_args = f"/artifacts/CWD/benchmark {args.wall_clock_limit} {args.intent}"

    command = f"podman run -v .:/artifacts/CWD -t {args.image_name} --timestamp {runsolver_args} run_vampire {run_vampire_args}"
    if args.dry_run:
        print(command)
    else:
